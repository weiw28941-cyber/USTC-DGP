...
// Interaction State Node - consumes normalized viewer interaction events and
// exposes a channel-oriented state for downstream algorithm nodes.
class node_interaction_state : public NodeBase {
public:
